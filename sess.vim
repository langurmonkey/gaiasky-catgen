...
silent! normal! zE
let &fdl = &fdl
let s:l = 200 - ((22 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 200
...
silent! normal! zE
let &fdl = &fdl
let s:l = 546 - ((39 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 546
...
silent! normal! zE
let &fdl = &fdl
let s:l = 390 - ((27 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 390
...
silent! normal! zE
let &fdl = &fdl
let s:l = 272 - ((39 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 272
